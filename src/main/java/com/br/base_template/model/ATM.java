...
@Entity
@Table(name = "\"atm\"", schema = "\"PresentialServiceChannels\"")
public class ATM {
    ...
    @Column(name = "atmidentifier", length = 16, nullable = false)
    ...
    @Column(name = "atmattentionhour")
    private String atmAttentionHour;

    @Column(name = "atmservicetype", length = 4, nullable = false)
    private String atmServiceType;

    @Column(name = "atmaccesstype", length = 4, nullable = false)
